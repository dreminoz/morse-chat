...
MongoDB stores accounts and nicknames, login sessions, profile data, direct-message history, and Space signals. Random Signal live matching remains in server memory because it represents active connections rather than saved history.
